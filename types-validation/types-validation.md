...
| --- | --- | --- | --- | --- |
| 608 | 552 (90.8%) | 56 (9.2%) | 124 (20.4%) | 0 (0%) |
...
|  | Total types | Validated | Failing | Missing test | Missing types |
| --- | --- | --- | --- | --- | --- |
| `stable` | 505 | 455 (90.1%) | 50 (9.9%) | 104 | 0 |
...
| `xpack.info` | :red_circle: | 8/8 | 1/4 | stable | undefined |  |
| `delete` | :red_circle: | 43/46 | 46/46 | stable | undefined |  |
| `async_search.submit` | :red_circle: | 8/8 | 7/8 | stable | undefined |  |
| `async_search.get` | :red_circle: | 7/7 | 6/7 | stable | undefined |  |
| `indices.get_mapping` | :red_circle: | 285/285 | 242/285 | stable | undefined |  |
...
| `indices.create` | :red_circle: | 1665/1770 | 1770/1770 | stable | undefined |  |
...
:construction: 31.9% namespaces have failures, and the namespace with the most failures is [`xpack`](#xpack) with 100% failures.
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `delete` | :green_circle: | 5/5 | 5/5 | stable | undefined |  |
| `get` | :red_circle: | 7/7 | 6/7 | stable | undefined |  |
| `status` | :green_circle: | 3/3 | 3/3 | stable | undefined |  |
| `submit` | :red_circle: | 8/8 | 7/8 | stable | undefined |  |
| **Summary** | :red_circle: | 100% | 91.3% | | | |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `bulk` | :green_circle: | 707/707 | 725/725 | stable | undefined |  |
...
| `delete_by_query_rethrottle` | :white_circle: | Missing test | Missing test | stable | undefined |  |
...
| `get` | :red_circle: | 461/473 | 465/470 | stable | undefined |  |
| `get_reindex` | :white_circle: | Missing test | Missing test | stable | undefined |  |
...
| `mget` | :green_circle: | 57/57 | 56/56 | stable | undefined |  |
...
| `put_script` | :green_circle: | 50/50 | 50/50 | stable | undefined |  |
| `rank_eval` | :green_circle: | 1/1 | 1/1 | stable | undefined |  |
| `reindex` | :red_circle: | 83/86 | 85/85 | stable | undefined |  |
| `reindex_rethrottle` | :green_circle: | 10/10 | 10/10 | stable | undefined |  |
...
| `circuit_breaker` | :green_circle: | 6/6 | 6/6 | stable | undefined |  |
...
| `delete_component_template` | :green_circle: | 3/3 | 3/3 | stable | undefined |  |
...
| `get_component_template` | :red_circle: | 16/16 | 14/16 | stable | undefined |  |
| `get_settings` | :green_circle: | 10/10 | 10/10 | stable | undefined |  |
| `health` | :green_circle: | 274/274 | 274/274 | stable | undefined |  |
...
| `put_component_template` | :green_circle: | 42/42 | 42/42 | stable | undefined |  |
| `put_settings` | :green_circle: | 85/85 | 84/84 | stable | undefined |  |
| `remote_info` | :green_circle: | 3/3 | 3/3 | stable | undefined |  |
| `reroute` | :green_circle: | 8/8 | 7/7 | stable | undefined |  |
| `state` | :green_circle: | 96/96 | 95/95 | stable | undefined |  |
| `stats` | :green_circle: | 28/28 | 28/28 | stable | undefined |  |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `get_recovery_points` | :white_circle: | Missing test | Missing test | stable | undefined |  |
| **Summary** | :white_circle: | 0% | 0% | | | |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `reset` | :white_circle: | Missing test | Missing test | experimental | undefined |  |
| **Summary** | :white_circle: | 0% | 0% | | | |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `delete_policy` | :green_circle: | 13/13 | 13/13 | stable | undefined |  |
| `execute_policy` | :green_circle: | 11/11 | 11/11 | stable | undefined |  |
| `get_policy` | :green_circle: | 6/6 | 6/6 | stable | undefined |  |
| `put_policy` | :green_circle: | 14/14 | 14/14 | stable | undefined |  |
...
| `delete_data_source` | :green_circle: | 5/5 | 0/0 | experimental | undefined |  |
| `delete_dataset` | :green_circle: | 2/2 | 0/0 | experimental | undefined |  |
| `delete_view` | :green_circle: | 6/6 | 0/0 | experimental | undefined |  |
| `get_data_source` | :green_circle: | 4/4 | 0/0 | experimental | undefined |  |
| `get_dataset` | :green_circle: | 4/4 | 0/0 | experimental | undefined |  |
...
| `query` | :green_circle: | 633/633 | 0/0 | stable | undefined |  |
...
| `put_lifecycle` | :green_circle: | 8/8 | 8/8 | stable | undefined |  |
...
| `analyze` | :green_circle: | 249/249 | 249/249 | stable | undefined |  |
...
| `create` | :red_circle: | 1665/1770 | 1770/1770 | stable | undefined |  |
...
| `explain_data_lifecycle` | :red_circle: | 4/4 | 3/4 | stable | undefined |  |
| `field_usage_stats` | :green_circle: | 5/5 | 5/5 | experimental | undefined |  |
| `flush` | :green_circle: | 68/68 | 68/68 | stable | undefined |  |
| `forcemerge` | :green_circle: | 33/33 | 33/33 | stable | undefined |  |
| `get` | :green_circle: | 69/69 | 69/69 | stable | undefined |  |
...
| `get_mapping` | :red_circle: | 285/285 | 242/285 | stable | undefined |  |
| `get_migrate_reindex_status` | :green_circle: | 1/1 | 1/1 | stable | undefined |  |
| `get_settings` | :red_circle: | 105/105 | 79/105 | stable | undefined |  |
...
| `modify_data_stream` | :red_circle: | 4/8 | 8/8 | stable | undefined |  |
| `open` | :green_circle: | 22/22 | 22/22 | stable | undefined |  |
| `promote_data_stream` | :white_circle: | Missing test | Missing test | stable | undefined |  |
| `put_alias` | :red_circle: | 67/67 | 22/67 | stable | undefined |  |
| `put_data_lifecycle` | :red_circle: | 9/10 | 10/10 | stable | undefined |  |
...
| `recovery` | :green_circle: | 12/12 | 12/12 | stable | undefined |  |
| `refresh` | :green_circle: | 534/534 | 534/534 | stable | undefined |  |
...
| `delete_region_policy` | :green_circle: | 8/8 | 8/8 | stable | undefined |  |
...
| `non_streaming_chat_completion` | :white_circle: | Missing test | Missing test | stable | undefined |  |
...
| `put_fireworksai` | :white_circle: | Missing test | Missing test | stable | undefined |  |
...
| `put_region_policy` | :green_circle: | 9/9 | 9/9 | stable | undefined |  |
...
| `put_pipeline` | :green_circle: | 71/71 | 71/71 | stable | undefined |  |
| `simulate` | :green_circle: | 11/11 | 11/11 | stable | undefined |  |
| **Summary** | :green_circle: | 100% | 100% | | | |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `deprecations` | :red_circle: | 2/2 | 0/2 | stable | undefined |  |
...
| `get_job_stats` | :green_circle: | 29/29 | 29/29 | stable | undefined |  |
...
| `open_job` | :green_circle: | 39/39 | 39/39 | stable | undefined |  |
...
| `start_datafeed` | :green_circle: | 20/20 | 20/20 | stable | undefined |  |
...
| `info` | :red_circle: | 125/125 | 29/125 | stable | undefined |  |
| `reload_secure_settings` | :green_circle: | 2/2 | 2/2 | stable | undefined |  |
| `stats` | :green_circle: | 55/55 | 55/55 | stable | undefined |  |
| `usage` | :green_circle: | 1/1 | 1/1 | stable | undefined |  |
| **Summary** | :red_circle: | 100% | 48.9% | | | |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `create_many_routing` | :white_circle: | Missing test | Missing test | experimental | undefined |  |
| `create_routing` | :white_circle: | Missing test | Missing test | experimental | undefined |  |
| `delete_routing` | :white_circle: | Missing test | Missing test | experimental | undefined |  |
| `get_many_routing` | :white_circle: | Missing test | Missing test | experimental | undefined |  |
| `get_routing` | :white_circle: | Missing test | Missing test | experimental | undefined |  |
...
| `put_ruleset` | :green_circle: | 18/18 | 18/18 | stable | undefined |  |
...
| `delete_service_token` | :green_circle: | 4/4 | 4/4 | stable | undefined |  |
| `delete_user` | :green_circle: | 9/9 | 9/9 | stable | undefined |  |
| `delete_user_managed_service_account` | :green_circle: | 4/4 | 4/4 | stable | undefined |  |
...
| `get_token` | :red_circle: | 28/28 | 26/27 | stable | undefined |  |
...
| `has_privileges` | :green_circle: | 34/34 | 34/34 | stable | undefined |  |
...
| `invalidate_token` | :green_circle: | 12/12 | 12/12 | stable | undefined |  |
...
| `create_repository` | :red_circle: | 28/33 | 33/33 | stable | undefined |  |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `logs_disable` | :green_circle: | 6/6 | 6/6 | experimental | undefined |  |
| `logs_enable` | :green_circle: | 21/21 | 21/21 | experimental | undefined |  |
...
| `get_synonym` | :green_circle: | 25/25 | 25/25 | stable | undefined |  |
| `get_synonym_rule` | :green_circle: | 4/4 | 4/4 | stable | undefined |  |
| `get_synonyms_sets` | :green_circle: | 7/7 | 7/7 | stable | undefined |  |
| `put_synonym` | :green_circle: | 46/46 | 46/46 | stable | undefined |  |
| `put_synonym_rule` | :green_circle: | 6/6 | 6/6 | stable | undefined |  |
| **Summary** | :green_circle: | 100% | 100% | | | |
...
| API | Status | Request | Response | Stability | Visibility | Meta |
| --- | --- | --- | --- | --- | --- | --- |
| `cancel` | :green_circle: | 4/4 | 4/4 | experimental | undefined |  |
| `get` | :green_circle: | 29/29 | 29/29 | experimental | undefined |  |
...
| `start_transform` | :red_circle: | 33/34 | 34/34 | stable | undefined |  |
| `stop_transform` | :green_circle: | 19/19 | 19/19 | stable | undefined |  |
| `update_transform` | :green_circle: | 16/16 | 16/16 | stable | undefined |  |
...
| `execute_watch` | :green_circle: | 61/61 | 61/61 | stable | undefined |  |
| `get_settings` | :green_circle: | 4/4 | 4/4 | stable | undefined |  |
| `get_watch` | :red_circle: | 42/42 | 39/42 | stable | undefined |  |
| `put_watch` | :red_circle: | 56/60 | 60/60 | stable | undefined |  |
